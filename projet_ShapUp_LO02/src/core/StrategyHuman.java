...
class StrategyHuman extends Strategy {
	...
	public void computeBestMove(ArrayList<Card> victoryCards)//advanced
	{
		...
		do {
			...
			{
				do {
					System.out.println("Quelle carte veux tu jouer et où ?");
					...
					while (!choicePlace.matches("^[0-2]:[0-9],[0-9]$")) {
						System.out.println("Mauvaise saisie, indique le numéro de ta carte (0-2) et l'endroit auquel tu veux la poser.");
